...
;; another. Ben Bitdiddle claims that this can be accomplished with
;; the following procedure, even if there are multiple people
;; concurrently transferring money among multiple accounts, using any
;; account mechanism that serializes deposit and withdrawal
;; transactions, for example, the version of `make-account' in the
;; text above.
;;
...
;; As such. the following call will make me very very rich:

;; (transfer aarons-account ryans-account 1000000)
